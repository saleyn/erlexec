...
inline int sigmask_ex(int how, const sigset_t* set, sigset_t* oset) {
#if defined(_REENTRANT) && _POSIX_THREADS > 0
 ...
 * 
 * Copyright (c) 2012-2015  William Ahern <william@25thandClement.com>
 * See: https://github.com/wahern/cqueues/blob/snap-20160812/src/cqueues.c#L2451
 */
int pselectx(int nfds, fd_set* _rfds, fd_set* wfds, fd_set* efds,
    ...
    if (_mask)
        ...
        sigmask_ex(SIG_SETMASK, NULL, &mask);
